...
- 📺 4-розрядний 7-сегментний дисплей у форматі XX.XX
- 🔘 Простий інтерфейс з однією кнопкою
- ⏱️ Максимальний час вимірювання: 99.99 секунд
...
- `displayTimeDigits()` - Відображення часу з десятковою крапкою
